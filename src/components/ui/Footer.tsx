      ...
      <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">
            Easily find projects that match your skills and interests through
            tag-based search and curated recommendations. Whether it s a
            specific framework or tech stack, the platform helps you quickly
            connect with the right projects and teams.
          </p>
        ...
        <div className="flex flex-col">
          <div className="flex mt-24 mb-12 flex-row justify-between">
            <div className="">
              <h1 className="hidden md:block text-2xl cursor-pointer text-gray-600 hover:text-white uppercase">
                CODECOHORT
              </h1>
            </div>
